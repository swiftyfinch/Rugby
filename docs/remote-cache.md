...
1. Before using 🏈 Rugby you should be sure that your project code base is finalized.\
   △ For example, if you use `SwiftGen`, run it before calling Rugby.\
   Otherwise, your code base will be modified during building with Rugby. Then the hashes of binaries will not be suited;
